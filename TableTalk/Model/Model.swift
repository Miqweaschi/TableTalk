...
class Model: ObservableObject {
    ...
    static let l1b1: Esercizi<EsercizioContent, EsercizioContent> = Esercizi(items: [
        Esercizio(.text("This caprese salad is made of ___ and ___"), .text("Gay"), done: false),
        Esercizio(.text("The pizza ___ mushromms and cheese "), .text("Bene"), done: false),
        Esercizio(.text("Can i add ___ and ___ to my salad?"), .text("20"), done: false),
        Esercizio(.text("___ salt and olive oil to your salad?"), .text("Lunedi"), done: false)
